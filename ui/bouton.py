from FondMarin import Lili1, Lili2, Poli1, Poli2, fond, xf, yf, tlatba, gris, noir, blanc

class Bouton:
    def __init__(self, fonction, texte: str="", couleur: str=gris, etat: bool=True, nom: list=["bt"], taille: int=2) -> None:
        self.nom = nom
        self.texte = texte
        ...
        self.size = taille
        self.police = [Poli2, Poli1]
        if taille == 1:
            self.police = [Lili2, Lili1]
