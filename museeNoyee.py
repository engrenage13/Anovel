...
unload_image(ico)
ico = load_image('jeux/Jeu_1/images/Icones/organisation.png')
image_resize(ico, dim, dim)
orga = load_texture_from_image(ico)
image_resize(ico, mindim, mindim)
miniorga = load_texture_from_image(ico)
unload_image(ico)
ico = load_image('jeux/Jeu_1/images/Icones/abordage.png')
image_resize(ico, dim, dim)
abordage = load_texture_from_image(ico)
image_resize(ico, mindim, mindim)
miniabordage = load_texture_from_image(ico)
unload_image(ico)
ico = load_image('jeux/Jeu_1/images/Icones/degats.png')
image_resize(ico, dim, dim)
